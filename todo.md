...
- Transfer the 2d data folder to pendrive and give it to pranto

- update the backend with two models for xray and ct rate prediction. in CT scan user can send both .dcm and .png files. for xray user can send .png files. the backend will use the respective model to predict the severity score and return it to the frontend.
