...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-[#f8fafc] font-sans antialiased text-slate-800">
      ...
      <main className="flex-1 w-full mx-auto px-3 sm:px-6 py-10 sm:py-16">
        {/* Hero Section */}
        <div className="max-w-6xl mx-auto text-center space-y-3 max-w-2xl px-1 mb-12">
          <img
            src="/logo2.png"
            alt="Lumora Logo"
        ...
        <div id="upload-section" className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 items-start">
          {/* LEFT PANEL: Upload (5 cols) */}
